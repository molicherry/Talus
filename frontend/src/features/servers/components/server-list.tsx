...
export function ServerList() {
  ...
  const { data: servers, isLoading, isError, error, isFetching, refetch } = useServers();
  ...
  if (isError && servers === undefined) {
    return (
      <div className="rounded-2xl border border-danger/20 bg-danger-subtle p-8 text-center">
        <p className="text-sm text-danger">{translateApiError(error, t, t("server.loadError"))}</p>
                ...
                <Td className="sticky right-0 bg-card sm:static">
                  <div className="flex items-center justify-end gap-1">
                    <button
                      ...
                      className="touch-target inline-flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
                    ...
                    <button
                      ...
                      className="touch-target inline-flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-danger-subtle hover:text-danger"
