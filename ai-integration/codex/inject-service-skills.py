...
or any error -> prints nothing, conversation untouched.
...
Prerequisites (Codex 0.129+):
  ...
  - Project-level config.toml cannot set feature flags; must be user-level.

Install:
  1. Copy this file to .codex/hooks/inject-service-skills.py (project) or
     ~/.codex/hooks/inject-service-skills.py (user).
  2. Register in the matching hooks.json:
